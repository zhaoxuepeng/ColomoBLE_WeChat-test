...
/*
 *  Target : Texas Instruments CC2541 (8051 core)
 *
 */
 ...
 * ------------------------------------------------------------------------------------------------
 */
#define HAL_MCU_CC2541 // baowq: no use in OSAL
...
/* ------------------------------------------------------------------------------------------------
 *                                        CC2541 sleep common code
 * ------------------------------------------------------------------------------------------------
 */

/* PCON bit definitions */
#define PCON_IDLE  BV(0)            /* Writing 1 to force CC2541 to enter sleep mode */
