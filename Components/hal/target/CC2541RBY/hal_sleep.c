...
#if (defined DBG_UART) && (defined DBG_SLEEP)
  if(halPwrMgtMode==HAL_SLEEP_DEEP)
    printf("Sleep Mode: PM3\r\n");
  else if(halPwrMgtMode==HAL_SLEEP_TIMER)
    printf("Sleep Mode: PM2\r\n");
  else
    printf("Sleep Mode: PM0\r\n");
#endif
